...
from engine import run_backtest, calculate_indicators

st.set_page_config(
    page_title="V-ORB 2.0 Backtester",
    page_icon="⚡",
    layout="wide"
)

# Custom Styling matching dark mode dashboards
st.markdown("""
<style>
    .metric-card {
...
def load_data():
    try:
        ...
        generate_sample_data.generate_stock_data()
        return pd.read_csv("sample_data.csv")
